...
program
  ...
  .option('-u, --user <user>', 'The GitHub user userOrOrgName. Skip if using organization userOrOrgName')
  .option('-o, --organization <organization>', 'The GitHub organization userOrOrgName. Skip if using user userOrOrgName')
...
const getRepositories = program.user
  ? getUserRepos
  : getOrganizationRepos;

getRepositories(name, program.token)
  .then((repoList) => {
